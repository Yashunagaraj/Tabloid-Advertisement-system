<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookads.aspx.cs" Inherits="greatseo_bookads" %>
...
<body class="seo_version">
					...
					<ul class="navbar-nav ml-auto">
						...
						<%--<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="greg.aspx">Client or Guest Registration</a>
								<a class="dropdown-item" href="glogin.aspx">Client or Guest Login</a>
    ...
    <div id="pricing" class="section pricing-bg">
        <div class="container">
            <div class="section-title text-center">
                <h3> Book Advertisements</h3>
                <p>Many advertisers drop the plan of releasing a newspaper Ad as the rates fail to fit their budget.Whatever be the case, newspaper Advertising plays a vital role in deciding whether one will release an Ad or not, which is why at Tabloid AdReady we have decided to work differently. Newspaper advertising cost cannot be treated as a commodity that can have a fixed price. At Tabloid ADReady, we believe that each release requirement is unique and needs to ne treadted accordingly </p>
            </div><!-- end title -->
                    ...
                    <div class="pricing pricing-palden">
						<div class="pricing-item">
						  <div class="pricing-deco">
							...
							<div class="pricing-price"><span class="pricing-currency">Rs.</span>12
							  <span class="pricing-period">/ day</span>
							</div>
							<h3 class="pricing-title">Newspaper</h3>
						  </div>
						  <ul class="pricing-feature-list">
							<li class="pricing-feature">1 page of space</li>
							<li class="pricing-feature">Support from Date of Appearance<br /> to next 2 days.</li>
							<!--<li class="pricing-feature">Limited cloud access</li>-->
						  </ul>
						 <a href=newspaperad.aspx> <button class="bttn-new-a">NEWS PAPER AD..</button></a>
						</div>
						...
						<div class="pricing-item">
						  <div class="pricing-deco">
							...
							<div class="pricing-price"><span class="pricing-currency">Rs.</span>25
							  <span class="pricing-period">/ day</span>
							</div>
							<h3 class="pricing-title">Magazine</h3>
						  </div>
						  <ul class="pricing-feature-list">
							<li class="pricing-feature">1 page of space</li>
							<li class="pricing-feature">Support from Date of Apperance<br /> to next 1 week.</li>
							<!--<li class="pricing-feature">Full cloud access</li>-->
						  </ul>
						  <a href=magzineadd.aspx> <button class="bttn-new-a">MAGAZINE AD..</button></a>
						</div>
					</div>
                </div><!-- end col -->
            </div><!-- end row -->
