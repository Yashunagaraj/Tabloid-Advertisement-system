<%@ Page Language="C#" AutoEventWireup="true" CodeFile="guestHomepage.aspx.cs" Inherits="greatseo_guestHomepage" %>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="sl-slider">
			...
			<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
				<div class="sl-slide-inner">
					...
					<h2>TABLOID ADREADY</h2>
					<blockquote><p>Tabloid Advertisement is a web application that deals with maintaining the advertisements given by the customers to the company. The main aim of this project is to provide advertisement details like advertisement cost in newspaper and magazines. Depending upon the budget they can allot the different advertisements. In this project the front end is developed by using ASP.NET and back end is developed ny using MySQL.</p>
    ...
    <div id="about" class="section wb nopadtop">
        <div class="container">
            <div class="row">
				<div class="col-md-6 m40">
                    <div class="message-box">
                       ...
                       <h1>WELCOME TO TABLOID ADREADY</h1>
                       <br />
                        <p><i><b>Advertising, Generally Speaking, is the promotion of goods, services, companies, and ideas, usually performed by an identified sponsor.Markerters see advertising as part of an overall promotional startegy.Other components of the promotional mix include publicity, public relations, personal selling, and sales promotion.</b></i></p>
						
						<p><i><b>The concept of advertising as assumed a dynamic form with the use of the various medioms of communications. From the Newspapers, Magazines, posters, Billboards to the commerical on TV, advertising as come a long way. Advertising as an effective medium, uses a varitey of techniques to create effective advertisements.</b></i></p>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
				...
				<div class="col-md-12">
					...
					<div class="tab-content">
						<div class="tab-pane fade show active" id="tab_a">
                            ...
                            <p><i><b>To provide innovative and effective integrated brand marketing and public relations solutions <br />which help are customers grow there bussinesses and realize their marketing goals.</b></i></p>
								</div>
						</div>
						<div class="tab-pane fade" id="tab_b">
							<div class="box-inner-m">
                            <p><i><b>Delivering Results-Oriented brand marketing programs and public relations campaigns<br /> that enhance our customers awareness, improve their sales and foster their growth.</b></i></p>
								</div>
						</div>
					</div>
				</div>				
			...
			<!--<div class="section-title text-center">               
                <h2>Our Values</h2>
                <p class="lead">Our people enjoy a personal stake in your continued success and take pride in what we do.</p>
                <ul>
                <li>We’re here to serve our clients.<br />
                    Our commitment to our clients is deeply ingrained in our corporate culture – <br />
                    and we go above and beyond every day to prove it. It’s in our DNA.
                </li>
                </ul>
            </div><!-- end title -->
