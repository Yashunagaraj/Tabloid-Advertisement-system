<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgotpwd.aspx.cs" Inherits="greatseo_fonts_forgotpwd" %>
    ...
    <table align=center class="w-100">
        <tr>
            <td colspan="2" 
                ...
                Reset Password </td>
            <td rowspan="3">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/greatseo/images (5).jpg" 
        ...
        <tr>
            <td class="style2" 
                ...
                style="font-family: 'book Antiqua'; font-size: 150%; font-weight: bold; font-style: normal; color: #FFFFFF;">
                <asp:HyperLink ID="HyperLink1" runat="server" 
                    NavigateUrl="~/greatseo/greg.aspx" Font-Bold="True" ForeColor="White">No Account ?</asp:HyperLink>
            &nbsp;&nbsp;
                </td>
            <td class="style1">
