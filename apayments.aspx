<%@ Page Language="C#" AutoEventWireup="true" CodeFile="apayments.aspx.cs" Inherits="greatseo_apayments" %>
    ...
    <table align=center class="w-100">
        <tr>
            <td style="text-align: center">
                <h2 style="font-family: 'book Antiqua'; font-size: 300%; font-weight: bold; font-style: normal">Orders and Payments</h2></td>
        </tr>
         
            <td class="style2">

                <asp:GridView ID="GridView1" runat="server" Width="617px" BackColor="White" 
                    BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="15" 
                    Font-Bold="False" GridLines="Vertical">
